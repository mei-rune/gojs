...
var ErrGroupInInitContext = gojs.NewInitContextError("Using group() in the init context is not supported")

// ErrCheckInInitContext is returned when check() are using in the init context
var ErrCheckInInitContext = gojs.NewInitContextError("Using check() in the init context is not supported")
